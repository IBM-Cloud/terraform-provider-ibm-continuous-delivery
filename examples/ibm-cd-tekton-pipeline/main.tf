...
resource "ibmcd_tekton_pipeline_definition" "tekton_pipeline_definition_instance" {
...
resource "ibmcd_tekton_pipeline_trigger_property" "tekton_pipeline_trigger_property_instance" {
...
resource "ibmcd_tekton_pipeline_property" "tekton_pipeline_property_instance" {
...
resource "ibmcd_tekton_pipeline_trigger" "tekton_pipeline_trigger_instance" {
...
resource "ibmcd_tekton_pipeline" "tekton_pipeline_instance" {
  worker {
    id = "id"
  }
}
...
data "ibmcd_tekton_pipeline_definition" "tekton_pipeline_definition_instance" {
  pipeline_id = var.tekton_pipeline_definition_pipeline_id
  definition_id = var.tekton_pipeline_definition_definition_id
}

// Create tekton_pipeline_trigger_property data source
data "ibmcd_tekton_pipeline_trigger_property" "tekton_pipeline_trigger_property_instance" {
  pipeline_id = var.tekton_pipeline_trigger_property_pipeline_id
  trigger_id = var.tekton_pipeline_trigger_property_trigger_id
...
data "ibmcd_tekton_pipeline_property" "tekton_pipeline_property_instance" {
  pipeline_id = var.tekton_pipeline_property_pipeline_id
  property_name = var.tekton_pipeline_property_property_name
}

// Create tekton_pipeline_trigger data source
data "ibmcd_tekton_pipeline_trigger" "tekton_pipeline_trigger_instance" {
  pipeline_id = var.tekton_pipeline_trigger_pipeline_id
  trigger_id = var.tekton_pipeline_trigger_trigger_id
}

// Create tekton_pipeline data source
data "ibmcd_tekton_pipeline" "tekton_pipeline_instance" {
