		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_definition.tekton_pipeline_definition", "id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_definition.tekton_pipeline_definition", "pipeline_id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_definition.tekton_pipeline_definition", "definition_id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_definition.tekton_pipeline_definition", "scm_source.#"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_definition.tekton_pipeline_definition", "service_instance_id"),
				),
			},
		},
	})
