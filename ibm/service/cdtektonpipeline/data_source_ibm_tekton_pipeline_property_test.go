		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "pipeline_id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "property_name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "type"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "property_name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "value"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "enum.#"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "default"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "type"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_property.tekton_pipeline_property", "path"),
				),
			},
		},
	})
