		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "pipeline_id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "trigger_id"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "property_name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "type"),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "property_name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "name"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "value"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "enum.#"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "default"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "type"),
					resource.TestCheckResourceAttrSet("data.ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "path"),
				),
			},
		},
	})
