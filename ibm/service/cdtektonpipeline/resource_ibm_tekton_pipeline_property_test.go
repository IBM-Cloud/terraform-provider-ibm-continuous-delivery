		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMTektonPipelinePropertyExists("ibmcd_tekton_pipeline_property.tekton_pipeline_property", conf),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "pipeline_id", pipelineID),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMTektonPipelinePropertyExists("ibmcd_tekton_pipeline_property.tekton_pipeline_property", conf),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "pipeline_id", pipelineID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "name", name),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "value", value),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "default", defaultVar),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "type", typeVar),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "path", path),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "pipeline_id", pipelineID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "name", nameUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "value", valueUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "default", defaultVarUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "type", typeVarUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_property.tekton_pipeline_property", "path", pathUpdate),
				),
			},
			resource.TestStep{
				ResourceName:      "ibmcd_tekton_pipeline_property.tekton_pipeline_property",
				ImportState:       true,
...
func testAccCheckIBMTektonPipelinePropertyDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "ibmcd_tekton_pipeline_property" {
			continue
		}
