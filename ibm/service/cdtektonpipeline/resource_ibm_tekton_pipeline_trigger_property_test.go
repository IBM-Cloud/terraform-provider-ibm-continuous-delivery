		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					testAccCheckIBMTektonPipelineTriggerPropertyExists("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", conf),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "pipeline_id", pipelineID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "trigger_id", triggerID),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "pipeline_id", pipelineID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "trigger_id", triggerID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "name", name),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "value", value),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "default", defaultVar),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "type", typeVar),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "path", path),
				),
			},
			resource.TestStep{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "pipeline_id", pipelineID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "trigger_id", triggerID),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "name", nameUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "value", valueUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "default", defaultVarUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "type", typeVarUpdate),
					resource.TestCheckResourceAttr("ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property", "path", pathUpdate),
				),
			},
			resource.TestStep{
				ResourceName:      "ibmcd_tekton_pipeline_trigger_property.tekton_pipeline_trigger_property",
				ImportState:       true,
...
func testAccCheckIBMTektonPipelineTriggerPropertyConfigBasic(pipelineID string, triggerID string) string {
	return fmt.Sprintf(`
		...
		resource "ibmcd_tekton_pipeline_trigger_property" "tekton_pipeline_trigger_property" {
			pipeline_id = "%s"
			trigger_id = "%s"
		}
...
func testAccCheckIBMTektonPipelineTriggerPropertyDestroy(s *terraform.State) error {
	...
	for _, rs := range s.RootModule().Resources {
		if rs.Type != "ibmcd_tekton_pipeline_trigger_property" {
			continue
		}
