...
VERSION_PACKAGE="github.com/terraform-providers/terraform-provider-ibm-continuous-delivery/version"
...
gox \
    ...
    -ldflags "${LD_FLAGS}" \
    -output "pkg/{{.OS}}_{{.Arch}}/terraform-provider-ibm-continuous-delivery" \
    .
