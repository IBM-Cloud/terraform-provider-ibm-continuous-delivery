...
You can import the `ibmcd_toolchain_tool_appconfig` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_appconfig.cd_toolchain_tool_appconfig <toolchain_id>/<tool_id>
```
