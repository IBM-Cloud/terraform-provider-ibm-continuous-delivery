---
layout: "ibm"
page_title: "IBM : ibmcd_toolchain_tool_custom"
description: |-
  Manages cd_toolchain_tool_custom.
subcategory: "CD Toolchain"
---

# ibmcd_toolchain_tool_custom
...
You can import the `ibmcd_toolchain_tool_custom` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_custom.cd_toolchain_tool_custom <toolchain_id>/<tool_id>
```
