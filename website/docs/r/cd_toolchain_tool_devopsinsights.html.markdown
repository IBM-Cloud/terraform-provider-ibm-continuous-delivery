...
You can import the `ibmcd_toolchain_tool_devopsinsights` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_devopsinsights.cd_toolchain_tool_devopsinsights <toolchain_id>/<tool_id>
```
