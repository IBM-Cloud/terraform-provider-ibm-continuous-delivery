...
You can import the `ibmcd_toolchain_tool_gitlab` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_gitlab.cd_toolchain_tool_gitlab <toolchain_id>/<tool_id>
```
