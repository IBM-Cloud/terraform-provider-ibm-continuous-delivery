...
You can import the `ibmcd_toolchain_tool_pipeline` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_pipeline.cd_toolchain_tool_pipeline <toolchain_id>/<tool_id>
```
