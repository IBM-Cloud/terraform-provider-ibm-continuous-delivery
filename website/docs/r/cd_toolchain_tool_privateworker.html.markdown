---
layout: "ibm"
page_title: "IBM : ibmcd_toolchain_tool_privateworker"
description: |-
  Manages cd_toolchain_tool_privateworker.
subcategory: "CD Toolchain"
---

# ibmcd_toolchain_tool_privateworker
...
You can import the `ibmcd_toolchain_tool_privateworker` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_toolchain_tool_privateworker.cd_toolchain_tool_privateworker <toolchain_id>/<tool_id>
```
