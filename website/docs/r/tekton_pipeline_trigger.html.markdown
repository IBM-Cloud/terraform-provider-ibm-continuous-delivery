---
layout: "ibm"
page_title: "IBM : ibmcd_tekton_pipeline_trigger"
description: |-
  Manages tekton_pipeline_trigger.
subcategory: "CD Tekton Pipeline"
---

# ibmcd_tekton_pipeline_trigger
...
You can import the `ibmcd_tekton_pipeline_trigger` resource by using `id`.
...
# Syntax
```
$ terraform import ibmcd_tekton_pipeline_trigger.tekton_pipeline_trigger <pipeline_id>/<trigger_id>
```
